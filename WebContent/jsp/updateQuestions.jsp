...
<body>
<form id="fm" method="post" action="${pageContext.request.contextPath }/managerUpdateQuestion1"> 
		<table cellpadding="10px">
			<tr>
				<td>编号</td>
				<td><input id="name" class="easyui-validatebox" name="id" data-options="required:true,panelHeight:'auto'"></td>
			</tr>
			<tr>
				<td>所属套题</td>
