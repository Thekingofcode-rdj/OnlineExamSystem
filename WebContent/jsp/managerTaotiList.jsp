...
<script type="text/javascript">
	$(function(){
		$("#dg").datagrid({
			url:'${pageContext.request.contextPath}/managerGetTaotiList1',
			pagination:true,
			fit:true,
			fitColumns:true,
			toolbar:'#tb',
	...
	function openUpdateDialog(){
		...
		window.location.href = "updateTaoti.jsp";
	...
	function deleteTaoti(){
		...
		$.messager.confirm("系统提示","确定要删除这"+selections.length+"条数据吗？",function(r){
			if (r) {
				$.ajax({
					url:'${pageContext.request.contextPath }/managerDeleteTaoti1',
					data:idsStr,
					type:'post',
...
<table id="dg"></table>
<div id="tb">
	<a href="addTaoti.jsp" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">添加套题</a>
	<a href="javascript:openUpdateDialog()" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true">修改套题</a>
	<a href="javascript:deleteTaoti()" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true">删除套题</a>
</div>
