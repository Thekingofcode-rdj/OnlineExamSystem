...
<script type="text/javascript">
	...
	function deleteManager(){
		...
		$.messager.confirm("系统提示","确定要删除这"+selections.length+"条数据吗？",function(r){
			if (r) {
				$.ajax({
					url:'${pageContext.request.contextPath }/managerDelete1',
					data:idsStr,
					type:'post',
...
<table id="dg" class="easyui-datagrid" data-options="fit:true,fitColumns:true,pagination:true,rownumbers:true,toolbar:'#tb',
	url:'${pageContext.request.contextPath}/managerGetList1'">
	<thead>
		<tr>
...
<div id="tb">
	&nbsp;<a href="addManager.jsp" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">添加</a>
